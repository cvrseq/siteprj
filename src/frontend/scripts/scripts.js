const themeToggle = document.getElementById('theme-icon'); // Иконка, на которую нажимаем

themeToggle.addEventListener('click', function () {
  // Переключаем класс dark-theme на body для изменения темы
  document.body.classList.toggle('dark-theme');

  // Меняем иконку в зависимости от текущей темы
  if (document.body.classList.contains('dark-theme')) {
    // Если тёмная тема активна, меняем иконку на солнце
    ...
    // Если светлая тема активна, меняем иконку на луну
